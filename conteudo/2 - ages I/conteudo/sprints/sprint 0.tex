...
Na Sprint 0 era previsto que o grupo realizasse os mockups do Figma \cite{figma-help}, as
...
WebDevelopment(\ac{html} e \ac{css} básico), além de relembrar como funcionava o uso
...
sendo 2 de criação de pergunta para \ac{rh} (checkbox e múltipla escolha), 2 de
...
ainda mais se utilizando dos plugins Prettier \cite{prettier-docs} e ESLint
