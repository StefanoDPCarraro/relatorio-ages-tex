...
além disso a organização de código Html e TypeScript na mesma página facilita a
compreensão de iniciantes no desenvolvimento web.

  Já para estilização foi utilizado o Sass, uma extensão de Css que simplifica operações lógicas, como criação de
variáveis, aninhamento hierárquico de código, do ponto de vista técnico ele não difere
em nada do Css, já que após compilado vira Css, ainda assim facilita muito a vida de
iniciantes com sintaxes mais simples.

  Já na parte do back-end foi utilizado o framework NestJS com a linguagem
TypeScript, para a criação de uma RestAPI. Além disso, como tecnologia de
