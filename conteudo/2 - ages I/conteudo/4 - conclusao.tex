...
fiquei satisfeito com meu comprometimento e minhas \textit{soft skills} como Ages I, sendo
...
de Configuração de Software e uma parte de \ac{poo}, em que tivemos uma prévia de
...
introdução à programação funcional, em vez de apenas uma prévia. Além disso,
...
orientação dos Ages 1, pois vi integrantes do grupo Ages 1 um pouco mais tímidos
...
Também acredito que a falta de conhecimento do \textit{back-end} me forçou a
...
trabalhar mais no \textit{back-end} para garantir um conhecimento de \textit{full stack} e ter mais
