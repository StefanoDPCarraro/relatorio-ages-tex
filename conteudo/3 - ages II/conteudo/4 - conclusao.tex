...
e até saí de lá com várias amizades, tendo em vista o ótimo ambiente de trabalho
criado tanto pelo professor orientador, quanto pelos colegas. Acredito que houve
muitas trocas de informações valiosas e muitos momentos dos quais me lembrarei
para a minha vida nessa Ages.

Além disso, fiquei muito feliz de conseguir integrar conhecimentos de
matérias que estou fazendo em paralelo, para resolver tarefas da Ages, tendo como
exemplo a matéria de Verificação e Validação de Software, que ensinou a
realizar testes unitários, de integração e de sistema, que foram um ótimo jeito de
garantir que os \textit{endpoints} do \textit{back-end} realmente estavam funcionando conforme
esperado.
...
quais colunas manter e quais descartar, sempre levando em conta que \textit{performance}
seria um problema, e uma expansão do conhecimento em \textit{front-end}, podendo
...
Por fim, também tive uma boa aula de Docker e \textit{deploys} com um de meus
...
conexão, integração e \textit{build} da imagem local do Docker, bem como \textit{dumps} e uso de
...
ótimo companheiro, tanto em \textit{soft skills} quanto \textit{hard skills}. Penso que chegarei com
