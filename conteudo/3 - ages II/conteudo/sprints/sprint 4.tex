...
obtido das spikes passadas, e o deploy na \ac{aws} do aplicativo. Da minha parte,
...
das \ac{ec2} \cite{aws-ec2-docs} estava apresentando falha. Já o front-end foi onde estive mais presente
...
apresentação e problemas de integração no deploy. Por fim, a \ac{api} utilizada para a
